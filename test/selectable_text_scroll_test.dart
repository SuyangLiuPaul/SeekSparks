...
//
// 2026-09-14, ported from YsWords, where it was found on 2026-08-31 and
// reported as "为什么有些信息的页面不能往上滑，有些可以" — some sermons
// scroll and some don't. Nothing was different about the sermons. What
// differed was where the thumb landed.
//
// This app inherited AppScrollBehavior from YsWords in August and did
// NOT inherit the fix, so the same bug shipped here and was reported
// the same way: 「这里的问题和之前一样下滑不了 之前words也有过」, on a
// 梁家鏗 block note and then on the sermon body. A fix that lives in one
// of two forked apps is half a fix; this file is the other half.
//
