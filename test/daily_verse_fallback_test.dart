...
import 'package:yahwehs_sword/services/daily_verse_fallback.dart';
...
///
/// 2026-08 (ported from YsWords v1.4.0): LJK1 (`biblexg`/`biblexg-tr`)
/// was removed outright — only LJK2 (`biblexg-v2*`) remains in the
/// fallback chain now.
void main() {
