...
//
// 2026-09-15, photographed off a phone. The report was against the
// sibling Words app, whose projector put
//
...
// This app's projector was ported from the same source and had the
// identical gap, unreported only because nobody had projected a verse
// that carries a note yet.
//
...
Future<void> _wall(
  ...
  await tester.pumpWidget(MaterialApp(
    theme: ThemeData(extensions: const [WbColors.dark]),
    home: Scaffold(
