/// `[SeekSparks 1.6.317 web] Bad state: No element` — reproduced, then
/// fixed. See `lib/utils/safe_item_scroll.dart` for the diagnosis.
///
...
import 'package:yahwehs_sword/utils/safe_item_scroll.dart';
