...
| World History Wheel | A BibleWorks-style radial chronology (also rendered as a horizontal strip) spanning Creation through church history: 747 dated events, 226 world powers, 82 nations, 44 ministries, organised into 22 historical streams. Every date is conventional and independently sourced against public references — none was copied from any copyrighted chart (`docs/WHEEL-PROVENANCE.md`). |
