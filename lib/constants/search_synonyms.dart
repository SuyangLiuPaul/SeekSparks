...
const String kCuvSimplifiedChars =
    ...
    '来杨杰松极构枢枪枫柜标栋栏树栖样桨梁梦检棂楼榄槛横橹欢欲残殓殡殴毁毁毂毕毙气汉汤汹沟没沦沧泛泞泪泻泼'
    '洁洒洼浅浆浇浊测济浑浓涂涌涛涤润涨渊渎渐渔游湾湿溃溅滚满滤滥滨滩澜灭灯灵灾灿炉点炼烁烂烛烟烦烧烫热爱'
    '牵牺犊状犹独狭狮狱狸猎猪猫献玛环现玺珰琏琐璎瓮电画畅疖疟疮疯痒痨痪痫痴瘪瘫癣癫皱盏盐监盖盗盘睁瞒矶矿'
    '码砖确碍碜碱礼祷祸禀禄离秃种积称秽稣稳穑穷窃窍窑窜窝窥竖竞笃笔笼筑筛筹签签箩箫篓篮篱籴类粜粪粮系系紧'
    '红约级纪纬纯纲纳纵纶纷纸纹纺纽线练细织终绊经绑绒结绕给络绝统绣继续绰绳绵绸绺绿缄缅缆缒缓编缘缚缝缠缦'
    '缩网罗罚罢羁羡群耸耻聂聋职联聪肃肠肤肮肾肿胀胁胆胜胡胶脉脏脏脐脑脓脚脸腊腌腾致舍舱艰艳艺节芦苇苍苏苏'
    '苟苹范茔荆荐荚荡荡荣荤荫药莱莲获营萨蓝虑虚虫虽蚀蚁蚂蚕蛮蜗蜡蝇蝎衔补衮装裤见观规觅视觉觌觐触誉誊计订'
    '认讥讨让训议记讲讳讶讷许讹论讼设访诀证评诅识诈诉词诏译诓试诗诚话诡询该详诧诫诬语诮误诰诱诲说诵请诸诺'
    '读课诿谁调谄谅谆谈谊谋谎谏谒谕谗谜谢谣谤谦谨谬谱谷贝贞负贡财责贤败账货质贩贪贫贬贯贱贴贵贷贸费贺贻贼'
    '贾贿赀赁赂赃资赉赌赎赏赐赒赔赖赘赚赛赞赠赢赶趋跃践踊踪蹿车轧轨转轭轮软轰轴轻载轿较辅辆辇辈辉辋辎辐输'
    '辔辖辗辞辟辩辫边辽达迁过迈运还这进远违连迟迹迹适选逊递逻遗遥邻郑酿采释里鉴鉴錾针钉钏钓钝钢钥钦钩钮钱'
    '钹钻铁铃铅铊铙铛铜铠铭铮铲银铸铺链链销锁锄锅锈锈锉锋锐错锚锡锣锤锥锦锭锯锸锹镀镇镊镌镕镜镣镯镰镶长门'
...
const String kCuvTraditionalChars =
    ...
    '來楊傑鬆極構樞槍楓櫃標棟欄樹棲樣槳樑夢檢欞樓欖檻橫櫓歡慾殘殮殯毆毀燬轂畢斃氣漢湯洶溝沒淪滄氾濘淚瀉潑'
    '潔灑窪淺漿澆濁測濟渾濃塗湧濤滌潤漲淵瀆漸漁遊灣濕潰濺滾滿濾濫濱灘瀾滅燈靈災燦爐點煉爍爛燭煙煩燒燙熱愛'
    '牽犧犢狀猶獨狹獅獄貍獵豬貓獻瑪環現璽璫璉瑣瓔甕電畫暢癤瘧瘡瘋癢癆瘓癇癡癟癱癬癲皺盞鹽監蓋盜盤睜瞞磯礦'
    '碼磚確礙磣鹼禮禱禍稟祿離禿種積稱穢穌穩穡窮竊竅窯竄窩窺豎競篤筆籠築篩籌籤簽籮簫簍籃籬糴類糶糞糧繫係緊'
    '紅約級紀緯純綱納縱綸紛紙紋紡紐線練細織終絆經綁絨結繞給絡絕統繡繼續綽繩綿綢綹綠緘緬纜縋緩編緣縛縫纏縵'
    '縮網羅罰罷羈羨羣聳恥聶聾職聯聰肅腸膚骯腎腫脹脅膽勝鬍膠脈臟髒臍腦膿腳臉臘醃騰緻捨艙艱艷藝節蘆葦蒼蘇甦'
    '茍蘋範塋荊薦莢蕩盪榮葷蔭藥萊蓮獲營薩藍慮虛蟲雖蝕蟻螞蠶蠻蝸蠟蠅蠍銜補袞裝褲見觀規覓視覺覿覲觸譽謄計訂'
    '認譏討讓訓議記講諱訝訥許訛論訟設訪訣證評詛識詐訴詞詔譯誆試詩誠話詭詢該詳詫誡誣語誚誤誥誘誨説誦請諸諾'
    '讀課諉誰調諂諒諄談誼謀謊諫謁諭讒謎謝謠謗謙謹謬譜穀貝貞負貢財責賢敗賬貨質販貪貧貶貫賤貼貴貸貿費賀貽賊'
    '賈賄貲賃賂贓資賚賭贖賞賜賙賠賴贅賺賽讚贈贏趕趨躍踐踴蹤躥車軋軌轉軛輪軟轟軸輕載轎較輔輛輦輩輝輞輜輻輸'
    '轡轄輾辭闢辯辮邊遼達遷過邁運還這進遠違連遲蹟跡適選遜遞邏遺遙鄰鄭釀採釋裏鑒鑑鏨針釘釧釣鈍鋼鑰欽鈎鈕錢'
    '鈸鑽鐵鈴鉛鉈鐃鐺銅鎧銘錚鏟銀鑄鋪鏈鍊銷鎖鋤鍋鏽銹銼鋒鋭錯錨錫鑼錘錐錦錠鋸鍤鍬鍍鎮鑷鐫鎔鏡鐐鐲鐮鑲長門'
