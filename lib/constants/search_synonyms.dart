...
const String kCuvSimplifiedChars =
    ...
    '会伟传伤伦伪体余佛佣侧借债倾偿儿党兰关兴养兽内冈册写军农冲决况净凄准凉凋减凑几凤凭凯凶击凿划则刚创删'
    '别制剑剥劝办务动励劲劳势匀区医华协单卖卜卤卫却厂厅历厉压厌厕厨参双发发变叙叠只台叶号叹吁吃后吓吕吗听'
    '启吴呐呕员咙咸响哑哒哗唤啬喂喷嗳嘘嘱团园围囵国图圆圣场坏块坚坛坟坠垒垦垫堕墙壮声壶处备复复够头夸夹夺'
    '奁奋奖奥妆妇妈娇娈婴嫔孙学宁宝实宠审宫宽宾寝对寻导寿将尔尘尝尝尸尽层屉属屡岁岂岖岛岩岭岳峰帅师帐帘帜'
    '带帮干干并广庄庆床库应庙废廪开异弃弑张弥弯弹强归当录径御忆志忧怀态怜总恋恳恶恸恺恼悬悯惊惧惨惩惫惭惯'
    '愤愿懒戏战扎扑执扩扪扫扬扰抚抛抟抡抢护报抬担拟拢拣拥拦拧拨择挂挞挟挡挣挤损捡换捣据捻掳掷搀搁搂搅携摆'
    '摇撑撵攒敌敛数斋斗斩断无旧时旷昼显晋晒晓暂术朴机杀杂权杆条来杨杰松极构枢枪枫柜标栋栏树栖样桨梦检棂楼'
    '榄槛横橹欢残殓殡殴毁毂毕毙气汉汤汹沉沟没沦沧泞注泪泻泼洁洒洼浅浆浇浊测济浑浓涂涌涛涤润涨渊渎渐渔游湾'
    '湿溃溅滚满滤滥滨滩澜灭灯灵灶灾灿炉点炼烁烂烛烟烦烧烫热爱牵牺犊状犹独狭狮狱狸猎猪猫献玛环现玺琏琐璎瓮'
    '电画畅疖疟疮疯症痒痨痪痫痴瘪瘫癣癫皱盏盐监盖盗盘睁瞒矶矿码砖确碍碜碱礼祷祸禀禄离秃种积称秸秽稣稳穑穷'
    '窃窍窑窜窝窥竖竞笃笔笼筑筛筹签签箩箫篓篮篱籴类粜粪粮紧红约级纪纬纯纲纳纵纶纷纸纹纺纽线练细织终绊经绑'
    '绒结绕给络绝统绣继续绰绳绵绸绺绿缄缅缆缒缓编缘缚缝缠缦缩网罗罚罢羁羡群耸耻聂聋职联聪肃肠肤肮肾肿胀胁'
    '胆胜胡胶脉脏脐脑脓脚脸腊腾舱艰艳艺节芦芸苇苍苏苟苹范茔荆荐荚荡荣荤荫药莱莲获营萨蓝虑虚虫虽蚀蚁蚂蚕蛮'
    '蜗蜡蝇蝎衔补衮装裤见观规觅视觉觌觐触誉誊计订认讥讨让训议记讲讳讶讷许讹论讼设访诀证评诅识诈诉词诏译诓'
    '试诗诚话诡询该详诧诫诬语诮误诰诱诲说诵请诸诺读课诿谁调谄谅谆谈谊谋谎谏谒谕谗谜谢谣谤谦谨谬谱谷贝贞负'
    '贡财责贤败账货质贩贪贫贬贯贱贴贵贷贸费贺贻贼贾贿赀赁赂赃资赉赌赎赏赐赒赔赖赘赚赛赞赠赢赶趋跃践踊踪蹿'
    '车轧轨转轭轮软轰轴轻载轿较辅辆辇辈辉辋辎辐输辔辖辗辞辩辫边辽达迁过迈运还这进远违连迟迹适选逊递逻遗遥'
    '邻郑酿采释里鉴鉴錾针钉钏钓钝钢钥钦钩钮钱钹钻铁铃铅铊铙铛铜铠铭铮铲银铸铺链销锁锄锅锈锉锋锐错锚锡锣锤'
    '锥锦锭锯锸锹镀镇镊镌镜镣镯镰镶长门闩闪闭问闯闲间闵闷闸闹闺闻阁阄阉阔队阳阴阵阶陆陇陈险随隐隶难雏雾霉'
    '静面韦顶顷项顺须须顽顾顿颁颂预领颈颊颗题颜额颠颤风飕飘飞餍饥饫饭饮饰饱饶饷饼饿馆馈馋馍馐馑马驮驯驰驱'
    '驳驴驹驻驼驾驿骂骄骆骇验骏骑骗骚骟骡髅鬓鱼鲁鲜鳄鳞鸟鸠鸡鸣鸦鸪鸬鸱鸵鸶鸷鸽鸿鹈鹌鹑鹕鹚鹞鹤鹧鹭鹰鹳麦'
    '黄齐齿龈龙龛';
...
const String kCuvTraditionalChars =
    ...
    '會偉傳傷倫偽體餘彿傭側藉債傾償兒黨蘭關興養獸內岡冊寫軍農沖決況淨淒準涼雕減湊幾鳳憑凱兇擊鑿劃則剛創刪'
    '別製劍剝勸辦務動勵勁勞勢勻區醫華協單賣蔔鹵衞卻廠廳歷厲壓厭廁廚參雙發髮變敍疊隻臺葉號嘆籲喫後嚇呂嗎聽'
    '啓吳吶嘔員嚨鹹響啞噠嘩喚嗇餵噴噯噓囑團園圍圇國圖圓聖場壞塊堅壇墳墜壘墾墊墮牆壯聲壺處備復覆夠頭誇夾奪'
    '奩奮獎奧妝婦媽嬌孌嬰嬪孫學寧寶實寵審宮寬賓寢對尋導壽將爾塵嘗嚐屍盡層屜屬屢歲豈嶇島巖嶺嶽峯帥師帳簾幟'
    '帶幫乾幹並廣莊慶牀庫應廟廢廩開異棄弒張彌彎彈強歸當錄徑禦憶誌憂懷態憐總戀懇惡慟愷惱懸憫驚懼慘懲憊慚慣'
    '憤願懶戲戰紮撲執擴捫掃揚擾撫拋摶掄搶護報擡擔擬攏揀擁攔擰撥擇掛撻挾擋掙擠損撿換搗據撚擄擲攙擱摟攪攜擺'
    '搖撐攆攢敵斂數齋鬥斬斷無舊時曠晝顯晉曬曉暫術樸機殺雜權桿條來楊傑鬆極構樞槍楓櫃標棟欄樹棲樣槳夢檢欞樓'
    '欖檻橫櫓歡殘殮殯毆毀轂畢斃氣漢湯洶沈溝沒淪滄濘註淚瀉潑潔灑窪淺漿澆濁測濟渾濃塗湧濤滌潤漲淵瀆漸漁遊灣'
    '濕潰濺滾滿濾濫濱灘瀾滅燈靈竈災燦爐點煉爍爛燭煙煩燒燙熱愛牽犧犢狀猶獨狹獅獄貍獵豬貓獻瑪環現璽璉瑣瓔甕'
    '電畫暢癤瘧瘡瘋癥癢癆瘓癇癡癟癱癬癲皺盞鹽監蓋盜盤睜瞞磯礦碼磚確礙磣堿禮禱禍稟祿離禿種積稱稭穢穌穩穡窮'
    '竊竅窯竄窩窺豎競篤筆籠築篩籌簽籤籮簫簍籃籬糴類糶糞糧緊紅約級紀緯純綱納縱綸紛紙紋紡紐線練細織終絆經綁'
    '絨結繞給絡絕統繡繼續綽繩綿綢綹綠緘緬纜縋緩編緣縛縫纏縵縮網羅罰罷羈羨羣聳恥聶聾職聯聰肅腸膚骯腎腫脹脅'
    '膽勝鬍膠脈臟臍腦膿腳臉臘騰艙艱艷藝節蘆蕓葦蒼蘇茍蘋範塋荊薦莢蕩榮葷蔭藥萊蓮獲營薩藍慮虛蟲雖蝕蟻螞蠶蠻'
    '蝸蠟蠅蠍銜補袞裝褲見觀規覓視覺覿覲觸譽謄計訂認譏討讓訓議記講諱訝訥許訛論訟設訪訣證評詛識詐訴詞詔譯誆'
    '試詩誠話詭詢該詳詫誡誣語誚誤誥誘誨説誦請諸諾讀課諉誰調諂諒諄談誼謀謊諫謁諭讒謎謝謠謗謙謹謬譜穀貝貞負'
    '貢財責賢敗賬貨質販貪貧貶貫賤貼貴貸貿費賀貽賊賈賄貲賃賂贓資賚賭贖賞賜賙賠賴贅賺賽讚贈贏趕趨躍踐踴蹤躥'
    '車軋軌轉軛輪軟轟軸輕載轎較輔輛輦輩輝輞輜輻輸轡轄輾辭辯辮邊遼達遷過邁運還這進遠違連遲跡適選遜遞邏遺遙'
    '鄰鄭釀採釋裏鑒鑑鏨針釘釧釣鈍鋼鑰欽鈎鈕錢鈸鉆鐵鈴鉛鉈鐃鐺銅鎧銘錚鏟銀鑄鋪鏈銷鎖鋤鍋銹銼鋒鋭錯錨錫鑼錘'
    '錐錦錠鋸鍤鍬鍍鎮鑷鐫鏡鐐鐲鐮鑲長門閂閃閉問闖閑間閔悶閘鬧閨聞閣鬮閹闊隊陽陰陣階陸隴陳險隨隱隸難雛霧黴'
    '靜麵韋頂頃項順須鬚頑顧頓頒頌預領頸頰顆題顏額顛顫風颼飄飛饜饑飫飯飲飾飽饒餉餅餓館饋饞饃饈饉馬馱馴馳驅'
    '駁驢駒駐駝駕驛罵驕駱駭驗駿騎騙騷騸騾髏鬢魚魯鮮鱷鱗鳥鳩雞鳴鴉鴣鸕鴟鴕鷥鷙鴿鴻鵜鵪鶉鶘鶿鷂鶴鷓鷺鷹鸛麥'
    '黃齊齒齦龍龕';
