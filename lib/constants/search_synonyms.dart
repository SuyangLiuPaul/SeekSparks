...
const String kCuvSimplifiedChars =
    '万与丑专业丛东丝丢两严丧个丰临为丽举么么义乌乐习乡书买乱争于亏云亘亚产亩亲亵亿仅仆从仑仓仪们价仿众伙'
    '会伟传伤伦伪体余佛佣侧借债倾偿儿兑党兰关兴养兽内冈册写军农冲决况净凄准凉凋凌减凑几凤凭凯凶击凿划则刚'
    '创删别制剑剥劝办务动励劲劳势匀区医华协单卖卜卤卧卫却厂厅历厉压厌厕厨参双发发变叙叠只台叶号叹吁吃后吓'
    '吕吗听启吴呐呕员咙咸响哑哒哗唤啬喂喷嗳嘘嘱团园围囵国图圆圣场坏块坚坛坟坠垒垦垫堕墙壮声壶处备复复够头'
    '夸夹夺奁奋奖奥妆妇妈娇娈婴嫔孙学宁宝实宠审宫宽宾寝对寻导寿将尔尘尝尝尸尽层屉属屡岁岂岖岛岩岭岳帅师帐'
    '帘帜带帮干干并广庄庆库应庙废廪开异弃弑张弥弯弹强归当录径御忆志忧怀态怜总恋恳恶恸恺恼悦悬悯惊惧惨惩惫'
    '惭惯愤愿懒戏战户扎扑执扩扪扫扬扰抚抛抟抡抢护报抬担拟拢拣拥拦拧拨择挂挞挟挡挣挤损捡换捣据捻掳掷搀搁搂'
    '搅携摆摇撑撵攒敌敛数斋斗斩断无旧时旷昼显晋晒晓暂术朴机杀杂权杆条来杨杰松极构枢枪枫柜标栋栏树栖样桨梦'
    '检棂楼榄槛横橹欢残殓殡殴毁毂毕毙气汉汤汹沉沟没沦沧泞注泪泻泼洁洒洼浅浆浇浊测济浑浓涂涌涛涤润涨渊渎渐'
    '渔温游湾湿溃溅滚满滤滥滨滩澜灭灯灵灶灾灿炉点炼烁烂烛烟烦烧烫热爱牵牺犊状犹独狭狮狱狸猎猪猫献玛环现玺'
    '琏琐璎瓮电画畅疖疟疮疯症痒痨痪痫痴瘪瘫癣癫皱盏盐监盖盗盘着睁瞒矶矿码砖确碍碜碱礼祷祸禀禄离秃种积称秸'
    '秽税稣稳穑穷窃窍窑窜窝窥竖竞笃笔笼筑筛筹签签箩箫篓篮篱籴类粜粪粮紧红约级纪纬纯纲纳纵纶纷纸纹纺纽线练'
    '细织终绊经绑绒结绕给络绝统绣继续绰绳绵绸绺绿缄缅缆缒缓编缘缚缝缠缦缩网罗罚罢羁羡耸耻聂聋职联聪肃肠肤'
    '肮肾肿胀胁胆胜胡胶脉脏脐脑脓脚脱脸腊腾舱艰艳艺节芦芸苇苍苏苟苹范茔荆荐荚荡荣荤荫药莱莲获营萨葱蓝虑虚'
    '虫虽蚀蚁蚂蚕蛮蜗蜡蝇蝎衔补衮装裤见观规觅视觉觌觐触誉誊计订认讥讨让训议记讲讳讶讷许讹论讼设访诀证评诅'
    '识诈诉词诏译诓试诗诚话诡询该详诧诫诬语诮误诰诱诲说诵请诸诺读课诿谁调谄谅谆谈谊谋谎谏谒谕谗谜谢谣谤谦'
    '谨谬谱谷贝贞负贡财责贤败账货质贩贪贫贬贯贱贴贵贷贸费贺贻贼贾贿赀赁赂赃资赉赌赎赏赐赒赔赖赘赚赛赞赠赢'
    '赶趋跃践踊踪蹿车轧轨转轭轮软轰轴轻载轿较辅辆辇辈辉辋辎辐输辔辖辗辞辩辫边辽达迁过迈运还这进远违连迟迹'
    '适选逊递逻遗遥邻郑酿采释里鉴鉴錾针钉钏钓钝钢钥钦钩钮钱钹钻铁铃铅铊铙铛铜铠铭铮铲银铸铺链销锁锄锅锈锉'
    '锋锐错锚锡锣锤锥锦锭锯锸锹镀镇镊镌镜镣镯镰镶长门闩闪闭问闯闲间闵闷闸闹闺闻阁阄阉阔队阳阴阵阶陆陇陈险'
    '随隐隶难雏雾霉静面韦顶顷项顺须须顽顾顿颁颂预领颈颊颗题颜额颠颤风飕飘飞餍饥饫饭饮饰饱饶饷饼饿馆馈馋馍'
    '馐馑马驮驯驰驱驳驴驹驻驼驾驿骂骄骆骇验骏骑骗骚骟骡髅鬓鱼鲁鲜鳄鳞鸟鸠鸡鸣鸦鸪鸬鸱鸵鸶鸷鸽鸿鹈鹌鹑鹕鹚'
    '鹞鹤鹧鹭鹰鹳麦黄齐齿龈龙龛';

/// The Traditional character standing opposite each of
/// [kCuvSimplifiedChars], same index.
const String kCuvTraditionalChars =
    '萬與醜專業叢東絲丟兩嚴喪個豐臨為麗舉麽麼義烏樂習鄉書買亂爭於虧雲亙亞產畝親褻億僅僕從崙倉儀們價彷眾夥'
    '會偉傳傷倫偽體餘彿傭側藉債傾償兒兌黨蘭關興養獸內岡冊寫軍農沖決況淨淒準涼雕淩減湊幾鳳憑凱兇擊鑿劃則剛'
    '創刪別製劍剝勸辦務動勵勁勞勢勻區醫華協單賣蔔鹵臥衛卻廠廳歷厲壓厭廁廚參雙發髮變敘疊隻臺葉號嘆籲喫後嚇'
    '呂嗎聽啟吳吶嘔員嚨鹹響啞噠嘩喚嗇餵噴噯噓囑團園圍圇國圖圓聖場壞塊堅壇墳墜壘墾墊墮牆壯聲壺處備復覆夠頭'
    '誇夾奪奩奮獎奧妝婦媽嬌孌嬰嬪孫學寧寶實寵審宮寬賓寢對尋導壽將爾塵嘗嚐屍盡層屜屬屢歲豈嶇島巖嶺嶽帥師帳'
    '簾幟帶幫乾幹並廣莊慶庫應廟廢廩開異棄弒張彌彎彈強歸當錄徑禦憶誌憂懷態憐總戀懇惡慟愷惱悅懸憫驚懼慘懲憊'
    '慚慣憤願懶戲戰戶紮撲執擴捫掃揚擾撫拋摶掄搶護報擡擔擬攏揀擁攔擰撥擇掛撻挾擋掙擠損撿換搗據撚擄擲攙擱摟'
    '攪攜擺搖撐攆攢敵斂數齋鬥斬斷無舊時曠晝顯晉曬曉暫術樸機殺雜權桿條來楊傑鬆極構樞槍楓櫃標棟欄樹棲樣槳夢'
    '檢欞樓欖檻橫櫓歡殘殮殯毆毀轂畢斃氣漢湯洶沈溝沒淪滄濘註淚瀉潑潔灑窪淺漿澆濁測濟渾濃塗湧濤滌潤漲淵瀆漸'
    '漁溫遊灣濕潰濺滾滿濾濫濱灘瀾滅燈靈竈災燦爐點煉爍爛燭煙煩燒燙熱愛牽犧犢狀猶獨狹獅獄貍獵豬貓獻瑪環現璽'
    '璉瑣瓔甕電畫暢癤瘧瘡瘋癥癢癆瘓癇癡癟癱癬癲皺盞鹽監蓋盜盤著睜瞞磯礦碼磚確礙磣堿禮禱禍稟祿離禿種積稱稭'
    '穢稅穌穩穡窮竊竅窯竄窩窺豎競篤筆籠築篩籌簽籤籮簫簍籃籬糴類糶糞糧緊紅約級紀緯純綱納縱綸紛紙紋紡紐線練'
    '細織終絆經綁絨結繞給絡絕統繡繼續綽繩綿綢綹綠緘緬纜縋緩編緣縛縫纏縵縮網羅罰罷羈羨聳恥聶聾職聯聰肅腸膚'
    '骯腎腫脹脅膽勝鬍膠脈臟臍腦膿腳脫臉臘騰艙艱艷藝節蘆蕓葦蒼蘇茍蘋範塋荊薦莢蕩榮葷蔭藥萊蓮獲營薩蔥藍慮虛'
    '蟲雖蝕蟻螞蠶蠻蝸蠟蠅蠍銜補袞裝褲見觀規覓視覺覿覲觸譽謄計訂認譏討讓訓議記講諱訝訥許訛論訟設訪訣證評詛'
    '識詐訴詞詔譯誆試詩誠話詭詢該詳詫誡誣語誚誤誥誘誨說誦請諸諾讀課諉誰調諂諒諄談誼謀謊諫謁諭讒謎謝謠謗謙'
    '謹謬譜穀貝貞負貢財責賢敗賬貨質販貪貧貶貫賤貼貴貸貿費賀貽賊賈賄貲賃賂贓資賚賭贖賞賜賙賠賴贅賺賽讚贈贏'
    '趕趨躍踐踴蹤躥車軋軌轉軛輪軟轟軸輕載轎較輔輛輦輩輝輞輜輻輸轡轄輾辭辯辮邊遼達遷過邁運還這進遠違連遲跡'
    '適選遜遞邏遺遙鄰鄭釀採釋裏鑒鑑鏨針釘釧釣鈍鋼鑰欽鉤鈕錢鈸鉆鐵鈴鉛鉈鐃鐺銅鎧銘錚鏟銀鑄鋪鏈銷鎖鋤鍋銹銼'
    '鋒銳錯錨錫鑼錘錐錦錠鋸鍤鍬鍍鎮鑷鐫鏡鐐鐲鐮鑲長門閂閃閉問闖閑間閔悶閘鬧閨聞閣鬮閹闊隊陽陰陣階陸隴陳險'
    '隨隱隸難雛霧黴靜麵韋頂頃項順須鬚頑顧頓頒頌預領頸頰顆題顏額顛顫風颼飄飛饜饑飫飯飲飾飽饒餉餅餓館饋饞饃'
    '饈饉馬馱馴馳驅駁驢駒駐駝駕驛罵驕駱駭驗駿騎騙騷騸騾髏鬢魚魯鮮鱷鱗鳥鳩雞鳴鴉鴣鸕鴟鴕鷥鷙鴿鴻鵜鵪鶉鶘鶿'
    '鷂鶴鷓鷺鷹鸛麥黃齊齒齦龍龕';
