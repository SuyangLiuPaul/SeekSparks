...
const uiStrings = {
  ...
  'aboutVerLjk': {
    'zh-Hans': '梁简 / 梁繁 梁家铿译本（译者现行电子版，简 / 繁）',
    'zh-Hant': '梁简 / 梁繁 梁家鏗譯本（譯者現行電子版，簡 / 繁）',
    // 2026-09-18: the English name is the translator's own choice —
    // 「LJK Chinese translation」, not a surname-based gloss.
    'en':
        '梁简 / 梁繁 — LJK Chinese translation (the translator\'s current electronic edition, simplified / traditional)',
  },
  'aboutLicenseLjk': {
