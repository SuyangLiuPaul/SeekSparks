...
TravelDays? walkingDaysFor(double km) {
  ...
  return TravelDays(
    (km / kFootFastKmPerDay).ceil(),
    (km / kFootSlowKmPerDay).ceil(),
  );
}
...
class JourneyTravel {
  ...
  /// The estimate, over the land kilometres only. Null where the route has
  /// no land leg at all.
  TravelDays? get walk => walkingDaysFor(landKm);
