...
| `main` | **440084e** — #322's reference column was *measured* without the tracking it is *painted* with. Not deployed: the visible symptom was already fixed in v1.6.139, so this round's fix is reader-invisible and the undeployed counter stands at 1 of 3 |
| Suite | **3,304 tests**, green; `flutter analyze` exit 0 |
